...
import com.temportalist.scanner.common.item.ItemAugment;
import com.temportalist.scanner.common.packet.PacketRecieveAspect;
import com.temportalist.scanner.common.packet.PacketTileSync;
 ...
 */
@Mod(modid = TEC.MODID, name = "Scanner", version = "1.0")
public class TEC {
	...
	public void preinit(FMLPreInitializationEvent event) {
		...
		this.thaumicAnalyzer = new BlockThaumicAnalyzer(Material.rock, TEC.MODID,
				"thaumicAnalyzer");
