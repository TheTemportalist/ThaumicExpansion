...
import com.temportalist.thaumicexp.common.init.{TECBlocks, TECItems}
import com.temportalist.thaumicexp.common.network.{PacketSyncTicks, PacketGiveAspect, PacketColumnChange}
import com.temportalist.thaumicexp.server.CommandTEC
...
object TEC extends ModWrapper {
	...
	final val PROXY_CLIENT = "com.temportalist.thaumicexp.client.ProxyClient"
	final val PROXY_SERVER = "com.temportalist.thaumicexp.common.ProxyCommon"
	...
	def preInit(event: FMLPreInitializationEvent): Unit = {
		...
		PacketHandler.registerHandler(TEC.MODID,
			classOf[PacketColumnChange], classOf[PacketSyncTicks], classOf[PacketGiveAspect]
		)
